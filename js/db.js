...
export async function seedDatabase() {
  ...
  const v2Flag = await getSetting('seeded_v3');
  ...
  console.log('🔄 Cleared old data for v3 migration');
  ...
  await setSetting('seeded_v3', true);

  console.log('✅ Database seeded with EMS inventory data (v3 — clean state)');
}
